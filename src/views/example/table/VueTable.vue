<template>
    <div class="app-container calendar-list-container">
        ...
        <datasource language="en" :table-data="getData" :columns="columns" :pagination="information.pagination" :actions="actions" v-on:change="changePage" v-on:searching="onSearch">
        </datasource>
    </div>
</template>
...
export default {
    ...
    computed: {
        getData() {
            const self = this;
            return self.information.data.filter(d => {
